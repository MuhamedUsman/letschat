...
var (
	...
	ErrApplication = errors.New("your side of application have encountered an error, if the error persists you may report this issue to the developer at https://github.com/MuhamedUsman/letschat")
)
